package com.manish.authentication.security.oauth2;
...
import com.manish.authentication.security.oauth2.user.OAuth2UserInfo;
import com.manish.authentication.security.oauth2.user.OAuth2UserInfoFactory;
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        if (userOptional.isPresent()) {
            ...
            if (!user.getProvider()
                ...
                throw new BadRequestException("Looks like you're signed up with " + user.getProvider()
